...
RegisterClientPayload parseRegisterClient(const QJsonObject& obj)
{
    ...
    p.supportsAllUrlsCookiePermission = caps[QStringLiteral("allUrlsCookiePermission")].toBool(false);
    return p;
}
...
QJsonObject serializeRegisterClient(const RegisterClientPayload& p)
{
    ...
    obj[QStringLiteral("incognito")] = p.incognito;
    {
        ...
        caps[QStringLiteral("allUrlsCookiePermission")] = p.supportsAllUrlsCookiePermission;
