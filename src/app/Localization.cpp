...
const char* const providerErrorSources[] = {
    ...
    QT_TRANSLATE_NOOP("ProviderErrors", "CLI terminal capture failed for codex CLI."),
    QT_TRANSLATE_NOOP("ProviderErrors", "codex CLI still reports 'stdin is not a terminal' during terminal capture."),
    ...
    QT_TRANSLATE_NOOP("ProviderErrors", "CLI terminal capture failed for codex status probe."),
